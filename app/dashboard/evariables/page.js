...
export default function EnvPage() {
  ...
  const [drafts, setDrafts] = useState([{ key: "", value: "", note: "" }]);
          ...
          {envVars.length === 0 ? (
            <div className="border border-white/10 bg-white/5 min-h-[350px] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-white/40 max-w-md text-sm">
                Add Environment Variables to Production, Preview, and
                Development environments, including branches in Preview.
              </p>
            ...
            <div className="border border-white/10 bg-white/5">
              ...
              {envVars.map((item, index) => (
                <div
                  ...
                  <div className="col-span-2 text-white/50">{item.project}</div>
                </div>
              ))}
            </div>
          )}
